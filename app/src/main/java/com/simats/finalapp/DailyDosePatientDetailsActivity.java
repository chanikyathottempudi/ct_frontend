...
public class DailyDosePatientDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView patientNameTextView = findViewById(R.id.patient_name_daily_dose_details);
        patientNameTextView.setText(patientName + "'s Daily Dose Trend");

        LineChart lineChart = findViewById(R.id.daily_dose_line_chart);
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.navigation_dashboard) {
                ...
                // startActivity(new Intent(DailyDosePatientDetailsActivity.this, AdminActivity.class));
                return true;
            }
            return false;
        });
